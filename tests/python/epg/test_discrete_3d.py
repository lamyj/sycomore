...
class TestDiscrete3D(unittest.TestCase):
    ...
    def test_positive_gradient_x(self):
        ...
        self._test_model(
            model, 
            [[-5350*rad/m, 0*rad/m, 0*rad/m], 3*[0*rad/m]], 
            [
    ...
    def test_multiple_gradient(self):
        ...
        self._test_model(
            ...
            [
                [0, -0.045436496804645087-0.10704167849196657j, 0],
                [0, 0.19488966354917586+0.45913127494692113j, 0],
    ...
    def test_relaxation(self):
        ...
        self._test_model(
            ...
            [[-5350*rad/m, 0*rad/m, 0*rad/m], 3*[0*rad/m]], 
            [
                [0, 0.2585687448743616+0.6091497893403431j, 0],
    ...
    def test_diffusion_x(self):
        ...
        self._test_model(
            ...
            [[-5350*rad/m, 0*rad/m, 0*rad/m], 3*[0*rad/m]], 
            [
                [0, 0.25805117100742553+0.6079304617214332j, 0],
                [0, 0, 0.6851625292479138]])
    ...
    def test_off_resonance(self):
        ...
        self._test_model(
            ...
            [[-5350*rad/m, 0*rad/m, 0*rad/m], 3*[0*rad/m]],
            [
                [0, 0.6268924782754024+0.37667500256027975j, 0],
                [0, 0, 0.6819983600624985]])
    ...
    def test_time_interval_x(self):
        ...
        self._test_model(
            ...
            [[-5350*rad/m, 0*rad/m, 0*rad/m], 3*[0*rad/m]], 
            [
                [0, 0.2584947343504123+0.6089754314724013j, 0],
                [0, 0, 0.6851625292479138]])
    ...
    def test_apply_time_interval_field_off_resonance(self):
        ...
        model.apply_time_interval(
            10*ms, [2*mT/m, 0*mT/m, 0*mT/m], delta_omega=10*Hz)
        
        self._test_model(
            model, 
            [[-5350*rad/m, 0*rad/m, 0*rad/m], 3*[0*rad/m]], 
            [
                [0, 0.56707341067384409+0.34073208057155585j, 0],
                [0, 0, 0.6851625292479138]])
    ...
    def test_refocalization(self):
        ...
        self._test_model(
            ...
            [
                ...
                [0*rad/m, 0*rad/m, 0*rad/m]],
            [
                [0, 0.10210725404661349+0.17685495183007738j, 0],
                [
                    0,

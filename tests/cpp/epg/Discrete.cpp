...
BOOST_AUTO_TEST_CASE(Empty)
{
    ...
    BOOST_TEST((model.orders() == std::vector<int64_t>{0}));
...
BOOST_AUTO_TEST_CASE(PositiveGradient, *boost::unit_test::tolerance(1e-9))
{
    ...
    BOOST_TEST((model.orders() == std::vector<int64_t>{0, 5350}));
...
BOOST_AUTO_TEST_CASE(MultipleGradient, *boost::unit_test::tolerance(1e-9))
{
    ...
    BOOST_TEST((model.orders() == std::vector<int64_t>{0, 2675, 5350, 8025}));

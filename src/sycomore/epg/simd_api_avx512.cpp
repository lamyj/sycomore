...
template 
void apply_pulse_d<XSIMD_X86_AVX512_VERSION>(
    std::vector<Complex> const & T, 
    Complex * F, Complex * F_star, Complex * Z,
    unsigned int states_count);

template 
void relaxation_d<XSIMD_X86_AVX512_VERSION>(
...
template 
void diffusion_3d_b_d<XSIMD_X86_AVX512_VERSION>(

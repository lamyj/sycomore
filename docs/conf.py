...
latex_documents = [
    (master_doc, 'sycomore.tex', 'sycomore Documentation',
     'Julien Lamy', 'manual'),
]
...
man_pages = [
    (master_doc, 'sycomore', 'sycomore Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sycomore', 'sycomore Documentation',
     author, 'sycomore', 'One line description of project.',
     'Miscellaneous'),
]
